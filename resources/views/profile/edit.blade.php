...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __("Voici votre page de profil. Vous pouvez modifier votre profil et changer votre mot de passe"),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('argon') }}/img/theme/favicon.png" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Modifier le profil') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Information du profil') }}</h6>
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirmer nouveau mot de passe') }}</label>
